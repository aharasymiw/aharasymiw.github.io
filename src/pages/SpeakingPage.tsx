      ...
      <Section>
        ...
        <div className={styles.talkGrid}>
          <RevealOnScroll>
            ...
            >
              <Text>
                ...
                Explored the journey from traditional passwords to modern passwordless
                authentication.
              </Text>
          ...
          <RevealOnScroll delay={200}>
            ...
            >
              <Text>
                An honest exploration of career transitions, from mathematics to software
                engineering to education, and the lessons learned along the way.
              </Text>
            </Card>
          </RevealOnScroll>
        </div>
            ...
            <AccordionItem title="Professional Development">
              <div className={styles.talkList}>
                <div className={styles.talkEntry}>
                  ...
                  <Text>
                    Strategic advice for evaluating opportunities and managing professional growth.
                  </Text>
                </div>
                <div className={styles.talkEntry}>
                  <Heading level={4} size="base">
                  ...
                  <Text variant="muted">2022</Text>
                  <Text>
                    Essential skills for navigating technical disagreements while maintaining
                ...
                <div className={styles.talkEntry}>
                  ...
                  <Text>
                    Candid discussion of leading remote teams, sharing both successes and ongoing
                    challenges.
                  </Text>
                </div>
              </div>
            ...
            <AccordionItem title="Technical Deep Dives">
              <div className={styles.talkList}>
                <div className={styles.talkEntry}>
                  ...
                  <Text>
                    Comprehensive exploration of error handling patterns in modern applications.
                  </Text>
                </div>
                <div className={styles.talkEntry}>
                  <Heading level={4} size="base">
                ...
                <div className={styles.talkEntry}>
                  ...
                  <Text variant="muted">2023</Text>
                  <Text>
                    Exploring the craft of software development beyond mere functionality.
                  </Text>
                </div>
              </div>
            </AccordionItem>
      ...
      <RevealOnScroll>
        <Section zone="warm">
          ...
          <Text>
            ...
            with technical tutorials for developers at all levels, plus in-depth articles at{" "}
            <Link href="https://grokthings.com" external>
              GrokThings
            </Link>{" "}
            covering algorithms, JavaScript, architecture, and learning strategies.
          </Text>
      ...
      <RevealOnScroll>
        <Section zone="playful" className={styles.bookingSection}>
          ...
          <Text>
            ...
            Available for conferences, workshops, podcasts, webinars, meetups, and corporate
            training.
          </Text>
