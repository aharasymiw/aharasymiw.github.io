        ...
        cards={[
          {
            ...
            color: "green",
            content:
              "A software engineer, educator, and advocate who believes technology is at its best when it brings people together.",
          },
          {
            label: "What",
            color: "warm",
            content:
              "Speaking, teaching, community building, and creating content that helps developers grow at every level.",
          },
          {
            label: "How",
            color: "playful",
            content:
              "With curiosity, collaboration, and the belief that meeting people where they are is the first step to going somewhere great.",
          },
        ]}
      />
          ...
          <Accordion>
            <AccordionItem title="Bootcamp Instructor & Software Engineer">
              <Text>
                ...
                clients. Specialized in PostgreSQL, Express, React, Node.js, and modern web
                technologies.
              </Text>
      ...
      <RevealOnScroll delay={200}>
        <Section zone="warm">
          ...
          <ul className={styles.valueList}>
            <li>
              <strong>Technical Credibility:</strong> Hands-on experience across the stack, from
              system design to deployment
            </li>
            <li>
              <strong>Educational Excellence:</strong> Proven ability to create content that
              resonates with developers at all levels
            </li>
            <li>
              <strong>Communication Skills:</strong> Years of public speaking training and practice
              through Toastmasters
            </li>
            <li>
              <strong>Community Focus:</strong> Deep understanding of what makes developer
              communities thrive
            </li>
            <li>
              <strong>Content Creation:</strong> Active production of tutorials, talks, articles,
              and educational materials
            </li>
            <li>
              <strong>Authentic Personality:</strong> Genuine enthusiasm for technology and helping
              others succeed
            </li>
          </ul>
        </Section>
